...
test_that("plotting works", {
    ...
    expect_doppel("compound-spec", function() plotSpec(compsMFIso, 1, names(compoundTable(compsMFIso))[2], plists, plotStruct = FALSE))
    expect_plot(plotSpec(compsMFIso, 1, names(compoundTable(compsMFIso))[2], plists, plotStruct = TRUE))
    # expect_doppel("spec-gg", plotSpec(compsMFIso, 1, names(compoundTable(compsMFIso))[1], plists, useGGPlot2 = TRUE))
    expect_ggplot(plotSpec(compsMFIso, 1, names(compoundTable(compsMFIso))[2], plists, useGGPlot2 = TRUE))
